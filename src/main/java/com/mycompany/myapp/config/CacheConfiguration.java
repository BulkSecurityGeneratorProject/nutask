...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(CourseRepository.COURSES_BY_ID, jcacheConfiguration);
            ...
            cm.createCache(com.mycompany.myapp.domain.User.class.getName() + ".courses", jcacheConfiguration);
