...
public class NutaskApp {

    private static final Logger log = LoggerFactory.getLogger(NutaskApp.class);

    private final Environment env;

    public NutaskApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(NutaskApp.class);
